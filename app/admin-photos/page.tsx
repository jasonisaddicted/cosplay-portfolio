...
export default function PublicAdminPhotosPage() {
  ...
  if (loading) {
    return <div style={{ padding: '20px', textAlign: 'center' }}><p>Loading photos...</p></div>;
  }

  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: 'system-ui' }}>
      <h1>📸 Photo Admin Panel (Test Version)</h1>
      {message && <div style={{ padding: '12px', marginBottom: '16px', background: '#222', borderRadius: '4px', textAlign: 'center' }}>{message}</div>}
            ...
            {photos.map((photo) => (
              ...
              >
                ...
                <div style={{ padding: '12px' }}>
                  ...
                  <p style={{ margin: '0 0 8px 0', fontSize: '0.85rem', color: '#999' }}>
                    Album: {photo.album}
                  </p>
                  <button
